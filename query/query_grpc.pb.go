...
const (
	...
	QueryService_FullSetQuery_FullMethodName               = "/query.QueryService/FullSetQuery"
	QueryService_PunctSetQuery_FullMethodName              = "/query.QueryService/PunctSetQuery"
	QueryService_BatchedFullSetQuery_FullMethodName        = "/query.QueryService/BatchedFullSetQuery"
	QueryService_FetchFullDB_FullMethodName                = "/query.QueryService/FetchFullDB"
	QueryService_SetParityQuery_FullMethodName             = "/query.QueryService/SetParityQuery"
	QueryService_PRSetWithListDecodingQuery_FullMethodName = "/query.QueryService/PRSetWithListDecodingQuery"
)
...
type QueryServiceClient interface {
	...
	PRSetWithListDecodingQuery(ctx context.Context, in *PRSetWithListDecodingMsg, opts ...grpc.CallOption) (*PRSetWithListDecodingResponse, error)
}
...
func (c *queryServiceClient) PlaintextQuery(ctx context.Context, in *PlaintextQueryMsg, opts ...grpc.CallOption) (*PlaintextResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_PlaintextQuery_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) FullSetQuery(ctx context.Context, in *FullSetQueryMsg, opts ...grpc.CallOption) (*FullSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_FullSetQuery_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) PunctSetQuery(ctx context.Context, in *PunctSetQueryMsg, opts ...grpc.CallOption) (*PunctSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_PunctSetQuery_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) BatchedFullSetQuery(ctx context.Context, in *BatchedFullSetQueryMsg, opts ...grpc.CallOption) (*BatchedFullSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_BatchedFullSetQuery_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) FetchFullDB(ctx context.Context, in *FetchFullDBMsg, opts ...grpc.CallOption) (QueryService_FetchFullDBClient, error) {
	stream, err := c.cc.NewStream(ctx, &QueryService_ServiceDesc.Streams[0], QueryService_FetchFullDB_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *queryServiceClient) SetParityQuery(ctx context.Context, in *SetParityQueryMsg, opts ...grpc.CallOption) (*SetParityQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_SetParityQuery_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) PRSetWithListDecodingQuery(ctx context.Context, in *PRSetWithListDecodingMsg, opts ...grpc.CallOption) (*PRSetWithListDecodingResponse, error) {
	out := new(PRSetWithListDecodingResponse)
	err := c.cc.Invoke(ctx, QueryService_PRSetWithListDecodingQuery_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServiceServer interface {
	...
	PRSetWithListDecodingQuery(context.Context, *PRSetWithListDecodingMsg) (*PRSetWithListDecodingResponse, error)
...
func (UnimplementedQueryServiceServer) PRSetWithListDecodingQuery(context.Context, *PRSetWithListDecodingMsg) (*PRSetWithListDecodingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PRSetWithListDecodingQuery not implemented")
}
...
func _QueryService_FullSetQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QueryService_FullSetQuery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _QueryService_PunctSetQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QueryService_PunctSetQuery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _QueryService_BatchedFullSetQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QueryService_BatchedFullSetQuery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _QueryService_PRSetWithListDecodingQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PRSetWithListDecodingMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServiceServer).PRSetWithListDecodingQuery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QueryService_PRSetWithListDecodingQuery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServiceServer).PRSetWithListDecodingQuery(ctx, req.(*PRSetWithListDecodingMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var QueryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PRSetWithListDecodingQuery",
			Handler:    _QueryService_PRSetWithListDecodingQuery_Handler,
		},
	},
